...
7. طبقة الإشعارات:
   ...
   - رموز OTP قصيرة العمر للشركات والمهندسين عبر البريد.
...
- Media mapping: `/media/`.
- يحتاج تطبيق migrations حتى `0009_portalotpchallenge_requestactivity_and_more`.
...
- بوابتا الشركة والمهندس تستخدمان جلسات موقعة قصيرة الوصول بعد تحقق Email OTP.
